...
>[!VIDEO](https://video.tv.adobe.com/v/3449978?captions=ita&quality=12&learn=on){transcript=true}
...
>Per ulteriori informazioni, consulta la documentazione del prodotto nelle sezioni [Come definire i gruppi di controllo](https://experienceleague.adobe.com/docs/campaign-classic/using/orchestrating-campaigns/orchestrate-campaigns/marketing-campaign-target.html?lang=it#defining-a-control-group){target="_blank"} e [Popolazione target della consegna](https://experienceleague.adobe.com/docs/campaign-classic/using/sending-messages/key-steps-when-creating-a-delivery/steps-defining-the-target-population.html?lang=it){target="_blank"}
